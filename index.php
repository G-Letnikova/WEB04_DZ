      ...
      <div class="w3-twothird">
        ...
        <?php for ($i = 0; $i < count($experience); $i++):  ?>
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['dataStartd'] ?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['dataEnd'] ?></span></h6>
